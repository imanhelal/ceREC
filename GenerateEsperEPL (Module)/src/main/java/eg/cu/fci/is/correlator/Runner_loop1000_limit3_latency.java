...
public class Runner_loop1000_limit3_latency {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        String epl_TE_d =" @Priority(5) @Name('TE_d') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'd' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='a' or activity='e')) -> every succ=UnlabeledEvent(activity='d') ]#time(60 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";

        String epl_TE_b =" @Priority(5) @Name('TE_b') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'b' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'd')) -> every succ=UnlabeledEvent(activity='b') ]#time(60 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";
        ...
        String epl_TE_e =" @Priority(5) @Name('TE_e') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'e' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b')) -> every succ=UnlabeledEvent(activity='e') ]#time(60 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";

        String epl_TE_f =" @Priority(5) @Name('TE_f') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'f' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b')) -> every succ=UnlabeledEvent(activity='f') ]#time(120 sec)  where succ.timestamp - pred.timestamp >= 120000 and succ.timestamp - pred.timestamp <=120000;";
        ...
        String epl_Correlate_d =" @Priority(20) @Name('Correlate_d') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'd'  group by caseID order by timestamp desc  ;";//limit 3

        String epl_Correlate_b =" @Priority(20) @Name('Correlate_b') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'b'  group by caseID order by timestamp desc  ;";//limit 3

        String epl_Correlate_c =" @Priority(20) @Name('Correlate_c') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'c'  group by caseID order by timestamp desc  ;";//limit 3

        String epl_Correlate_e =" @Priority(20) @Name('Correlate_e') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'e'  group by caseID order by timestamp desc  ;";//limit 3

        String epl_Correlate_f =" @Priority(20) @Name('Correlate_f') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'f'  group by caseID order by timestamp desc  ;";//limit 3

        String epl_Correlate_g =" @Priority(20) @Name('Correlate_g') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'g'  group by caseID order by timestamp desc  ;";//limit 3

        String epl_Correlate_h =" @Priority(20) @Name('Correlate_h') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'h'  group by caseID order by timestamp desc  ;";//limit 3
        ...
        String epl_Filter_e =" @Priority(50) @Name('Filter_e') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+" from LabeledEvent.win:time(1 sec) as T where activity = 'e'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";
        ...
        String epl_Filter_h =" @Priority(50) @Name('Filter_h') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+" from LabeledEvent.win:time(1 sec) as T where activity = 'h'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Fail = " @Priority(0) @Name('Fail') insert into FailCorrelation (activity , timestamp , initTime) select ue.activity, ue.timestamp,  "+initTime+" from pattern [ ue=UnlabeledEvent -> (timer:interval(120 sec) and not fe=FilterLabeledEvent(activity=ue.activity and timestamp=ue.timestamp)) ]";
