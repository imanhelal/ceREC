...
public class Runner_loop1000_latency_eventID {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
    	...
    	String labeledEvents = "C:\\IH\\Docs\\eclipse-ws2019\\CEPForEventCorrelation_latency\\loop1000_labeled_eventID_run05.csv";//_limit1_H_limit5
...
//        String epl_TE_d =" @Priority(5) @Name('TE_d') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'd' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='a' or activity='e')) -> every succ=UnlabeledEvent(activity='d') ]#time(61 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";
        String epl_TE_d =" @Priority(5) @Name('TE_d') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'd' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='a') or every pred=FilterLabeledEvent(activity='e')) -> (every succ=UnlabeledEvent(activity='d')) ]#time(61 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";

        String epl_TE_b =" @Priority(5) @Name('TE_b') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'b' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'd')) -> (every succ=UnlabeledEvent(activity='b')) ]#time(61 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";

        String epl_TE_c =" @Priority(5) @Name('TE_c') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'c' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b')) -> (every succ=UnlabeledEvent(activity='c')) ]#time(121 sec)  where succ.timestamp - pred.timestamp >= 120000 and succ.timestamp - pred.timestamp <=120000;";

        String epl_TE_e =" @Priority(5) @Name('TE_e') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'e' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b')) -> (every succ=UnlabeledEvent(activity='e')) ]#time(61 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";

        String epl_TE_f =" @Priority(5) @Name('TE_f') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'f' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b')) -> (every succ=UnlabeledEvent(activity='f')) ]#time(121 sec)  where succ.timestamp - pred.timestamp >= 120000 and succ.timestamp - pred.timestamp <=120000;";

        String epl_TE_g =" @Priority(5) @Name('TE_g') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'g' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'c')) -> (every succ=UnlabeledEvent(activity='g')) ]#time(61 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";

//        String epl_TE_h =" @Priority(5) @Name('TE_h') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'h' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='g' or activity='f')) -> every succ=UnlabeledEvent(activity='h') ]#time(61 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";
        String epl_TE_h =" @Priority(5) @Name('TE_h') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'h' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='g') or every pred=FilterLabeledEvent(activity='f')) -> (every succ=UnlabeledEvent(activity='h')) ]#time(61 sec)  where succ.timestamp - pred.timestamp >= 60000 and succ.timestamp - pred.timestamp <=60000;";

        String epl_Correlate_d =" @Priority(20) @Name('Correlate_d') insert into LabeledEvent (eventID, caseID, activity , timestamp, probability) select distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'd'  group by eventID, caseID order by timestamp desc ;";//limit 5 

        String epl_Correlate_b =" @Priority(20) @Name('Correlate_b') insert into LabeledEvent (eventID, caseID, activity , timestamp, probability) select distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'b'  group by eventID, caseID order by timestamp desc ;";//limit 5

        String epl_Correlate_c =" @Priority(20) @Name('Correlate_c') insert into LabeledEvent (eventID, caseID, activity , timestamp, probability) select distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'c'  group by eventID, caseID order by timestamp desc ;";//limit 5

        String epl_Correlate_e =" @Priority(20) @Name('Correlate_e') insert into LabeledEvent (eventID, caseID, activity , timestamp, probability) select distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'e'  group by eventID, caseID order by timestamp desc ;";//limit 5

        String epl_Correlate_f =" @Priority(20) @Name('Correlate_f') insert into LabeledEvent (eventID, caseID, activity , timestamp, probability) select distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'f'  group by eventID, caseID order by timestamp desc ;";//limit 5

        String epl_Correlate_g =" @Priority(20) @Name('Correlate_g') insert into LabeledEvent (eventID, caseID, activity , timestamp, probability) select distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'g'  group by eventID, caseID order by timestamp desc ;";//limit 5

        String epl_Correlate_h =" @Priority(20) @Name('Correlate_h') insert into LabeledEvent (eventID, caseID, activity , timestamp, probability) select distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'h'  group by eventID, caseID order by timestamp desc ;";//limit 5

        String epl_Filter_d =" @Priority(50) @Name('Filter_d') insert into FilterLabeledEvent (eventID, caseID, activity , timestamp, probability, initTime) select  distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+" as initTime from LabeledEvent.win:time(1 sec) as T where activity = 'd'  and probability >= 0.0 group by eventID, caseID, probability order by probability desc limit 1 ;";

        String epl_Filter_b =" @Priority(50) @Name('Filter_b') insert into FilterLabeledEvent (eventID, caseID, activity , timestamp, probability, initTime) select  distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+" as initTime from LabeledEvent.win:time(1 sec) as T where activity = 'b'  and probability >= 0.0 group by eventID, caseID, probability order by probability desc limit 1 ;";

        String epl_Filter_c =" @Priority(50) @Name('Filter_c') insert into FilterLabeledEvent (eventID, caseID, activity , timestamp, probability, initTime) select  distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+" as initTime from LabeledEvent.win:time(1 sec) as T where activity = 'c'  and probability >= 0.0 group by eventID, caseID, probability order by probability desc limit 1 ;";

        String epl_Filter_e =" @Priority(50) @Name('Filter_e') insert into FilterLabeledEvent (eventID, caseID, activity , timestamp, probability, initTime) select  distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+" as initTime from LabeledEvent.win:time(1 sec) as T where activity = 'e'  and probability >= 0.0 group by eventID, caseID, probability order by probability desc limit 1 ;";

        String epl_Filter_f =" @Priority(50) @Name('Filter_f') insert into FilterLabeledEvent (eventID, caseID, activity , timestamp, probability, initTime) select  distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+" as initTime from LabeledEvent.win:time(1 sec) as T where activity = 'f'  and probability >= 0.0 group by eventID, caseID, probability order by probability desc limit 1 ;";

        String epl_Filter_g =" @Priority(50) @Name('Filter_g') insert into FilterLabeledEvent (eventID, caseID, activity , timestamp, probability, initTime) select  distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+" as initTime from LabeledEvent.win:time(1 sec) as T where activity = 'g'  and probability >= 0.0 group by eventID, caseID, probability order by probability desc limit 1 ;";

        String epl_Filter_h =" @Priority(50) @Name('Filter_h') insert into FilterLabeledEvent (eventID, caseID, activity , timestamp, probability, initTime) select  distinct T.eventID, caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+" as initTime from LabeledEvent.win:time(1 sec) as T where activity = 'h'  and probability >= 0.0 group by eventID, caseID, probability order by probability desc limit 1 ;";
