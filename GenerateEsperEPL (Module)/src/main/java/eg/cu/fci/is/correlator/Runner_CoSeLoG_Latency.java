...
public class Runner_CoSeLoG_Latency {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
    	...
    	String labeledEvents = "C:\\IH\\Docs\\eclipse-ws2019\\CEPForEventCorrelation_latency\\CoSeLoG\\CoSeLoG_latency_mem2\\"+logName+logProbSuffix+logProb+logSuffix+logRun+".csv";
    	String failedEvents = "C:\\IH\\Docs\\eclipse-ws2019\\CEPForEventCorrelation_latency\\CoSeLoG\\CoSeLoG_latency_mem2\\"+logName+logProbSuffix+logProb+logSuffix+logRun+logFailed+".csv";
        ...
        String epl_TE_t06_determine_necessity_of_stop_advice =" @Priority(5) @Name('TE_t06_determine_necessity_of_stop_advice') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't06 determine necessity of stop advice' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='t14 determine document x request unlicensed' or activity='t05 print and send confirmation of receipt') -> every succ=UnlabeledEvent(activity='t06 determine necessity of stop advice'))  or ((every pred=FilterLabeledEvent(activity='t04 determine confirmation of receipt') and every inter1 = FilterLabeledEvent(activity='t02 check confirmation of receipt')) -> every succ=UnlabeledEvent(activity='t06 determine necessity of stop advice')) where timer:within(87 min) ]#time(87 min)  where ( pred.caseID = inter1.caseID and (succ.timestamp - max(pred.timestamp,inter1.timestamp)) >= 0 and (succ.timestamp - max(pred.timestamp,inter1.timestamp)) <=86340000 ) or ( succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=86340000 )  ;";

        String epl_Correlate_t15_print_document_x_request_unlicensed =" @Priority(20) @Name('Correlate_t15_print_document_x_request_unlicensed') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't15 print document x request unlicensed'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t14_determine_document_x_request_unlicensed =" @Priority(20) @Name('Correlate_t14_determine_document_x_request_unlicensed') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't14 determine document x request unlicensed'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t10_determine_necessity_to_stop_indication =" @Priority(20) @Name('Correlate_t10_determine_necessity_to_stop_indication') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't10 determine necessity to stop indication'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t19_determine_report_y_to_stop_indication =" @Priority(20) @Name('Correlate_t19_determine_report_y_to_stop_indication') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't19 determine report y to stop indication'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t20_print_report_y_to_stop_indication =" @Priority(20) @Name('Correlate_t20_print_report_y_to_stop_indication') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't20 print report y to stop indication'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t18_adjust_report_y_to_stop_indicition =" @Priority(20) @Name('Correlate_t18_adjust_report_y_to_stop_indicition') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't18 adjust report y to stop indicition'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t12_check_document_x_request_unlicensed =" @Priority(20) @Name('Correlate_t12_check_document_x_request_unlicensed') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't12 check document x request unlicensed'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t17_check_report_y_to_stop_indication =" @Priority(20) @Name('Correlate_t17_check_report_y_to_stop_indication') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't17 check report y to stop indication'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t03_adjust_confirmation_of_receipt =" @Priority(20) @Name('Correlate_t03_adjust_confirmation_of_receipt') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't03 adjust confirmation of receipt'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t07_1_draft_intern_advice_aspect_1 =" @Priority(20) @Name('Correlate_t07_1_draft_intern_advice_aspect_1') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't07-1 draft intern advice aspect 1'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t07_2_draft_intern_advice_aspect_2 =" @Priority(20) @Name('Correlate_t07_2_draft_intern_advice_aspect_2') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't07-2 draft intern advice aspect 2'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t07_3_draft_intern_advice_hold_for_aspect_3 =" @Priority(20) @Name('Correlate_t07_3_draft_intern_advice_hold_for_aspect_3') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't07-3 draft intern advice hold for aspect 3'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t07_4_draft_internal_advice_to_hold_for_type_4 =" @Priority(20) @Name('Correlate_t07_4_draft_internal_advice_to_hold_for_type_4') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't07-4 draft internal advice to hold for type 4'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t07_5_draft_intern_advice_aspect_5 =" @Priority(20) @Name('Correlate_t07_5_draft_intern_advice_aspect_5') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't07-5 draft intern advice aspect 5'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t08_draft_and_send_request_for_advice =" @Priority(20) @Name('Correlate_t08_draft_and_send_request_for_advice') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't08 draft and send request for advice'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t09_1_process_or_receive_external_advice_from_party_1 =" @Priority(20) @Name('Correlate_t09_1_process_or_receive_external_advice_from_party_1') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't09-1 process or receive external advice from party 1'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t09_2_process_or_receive_external_advice_from_party_2 =" @Priority(20) @Name('Correlate_t09_2_process_or_receive_external_advice_from_party_2') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't09-2 process or receive external advice from party 2'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t09_3_process_or_receive_external_advice_from_party_3 =" @Priority(20) @Name('Correlate_t09_3_process_or_receive_external_advice_from_party_3') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't09-3 process or receive external advice from party 3'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t09_4_process_or_receive_external_advice_from_party_4 =" @Priority(20) @Name('Correlate_t09_4_process_or_receive_external_advice_from_party_4') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't09-4 process or receive external advice from party 4'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t11_create_document_x_request_unlicensed =" @Priority(20) @Name('Correlate_t11_create_document_x_request_unlicensed') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't11 create document x request unlicensed'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t16_report_reasons_to_hold_request =" @Priority(20) @Name('Correlate_t16_report_reasons_to_hold_request') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't16 report reasons to hold request'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t02_check_confirmation_of_receipt =" @Priority(20) @Name('Correlate_t02_check_confirmation_of_receipt') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't02 check confirmation of receipt'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t04_determine_confirmation_of_receipt =" @Priority(20) @Name('Correlate_t04_determine_confirmation_of_receipt') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't04 determine confirmation of receipt'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t05_print_and_send_confirmation_of_receipt =" @Priority(20) @Name('Correlate_t05_print_and_send_confirmation_of_receipt') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't05 print and send confirmation of receipt'  group by caseID order by timestamp desc limit 3 ; ";

        String epl_Correlate_t06_determine_necessity_of_stop_advice =" @Priority(20) @Name('Correlate_t06_determine_necessity_of_stop_advice') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct T.caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , ( count(caseID, group_by:(timestamp,activity,caseID)) /count(all caseID, group_by:(timestamp,activity))) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't06 determine necessity of stop advice'  group by caseID order by timestamp desc limit 3 ; ";

        /*//Old way of calculating
        String epl_Correlate_t15_print_document_x_request_unlicensed =" @Priority(20) @Name('Correlate_t15_print_document_x_request_unlicensed') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , min(((select count(caseID)  from TempEvent.win:time_batch(1 sec) where caseID = T.caseID and activity = T.activity and timestamp=T.timestamp) /count(all caseID, group_by:timestamp)),1.0) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't15 print document x request unlicensed'  group by caseID order by timestamp desc limit 3; ";
        ...
        String epl_Correlate_t20_print_report_y_to_stop_indication =" @Priority(20) @Name('Correlate_t20_print_report_y_to_stop_indication') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , min(((select count(caseID)  from TempEvent.win:time_batch(1 sec) where caseID = T.caseID and activity = T.activity and timestamp=T.timestamp) /count(all caseID, group_by:timestamp)),1.0) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't20 print report y to stop indication'  group by caseID order by timestamp desc limit 3; ";
        ...
        String epl_Correlate_t03_adjust_confirmation_of_receipt =" @Priority(20) @Name('Correlate_t03_adjust_confirmation_of_receipt') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , min(((select count(caseID)  from TempEvent.win:time_batch(1 sec) where caseID = T.caseID and activity = T.activity and timestamp=T.timestamp) /count(all caseID, group_by:timestamp)),1.0) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't03 adjust confirmation of receipt'  group by caseID order by timestamp desc limit 3; ";
        ...
        String epl_Correlate_t07_3_draft_intern_advice_hold_for_aspect_3 =" @Priority(20) @Name('Correlate_t07_3_draft_intern_advice_hold_for_aspect_3') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , min(((select count(caseID)  from TempEvent.win:time_batch(1 sec) where caseID = T.caseID and activity = T.activity and timestamp=T.timestamp) /count(all caseID, group_by:timestamp)),1.0) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't07-3 draft intern advice hold for aspect 3'  group by caseID order by timestamp desc limit 3; ";
        ...
        String epl_Correlate_t11_create_document_x_request_unlicensed =" @Priority(20) @Name('Correlate_t11_create_document_x_request_unlicensed') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , min(((select count(caseID)  from TempEvent.win:time_batch(1 sec) where caseID = T.caseID and activity = T.activity and timestamp=T.timestamp) /count(all caseID, group_by:timestamp)),1.0) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 't11 create document x request unlicensed'  group by caseID order by timestamp desc limit 3; ";
		...
		//*/
        String epl_Filter_t15_print_document_x_request_unlicensed =" @Priority(50) @Name('Filter_t15_print_document_x_request_unlicensed') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't15 print document x request unlicensed'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t14_determine_document_x_request_unlicensed =" @Priority(50) @Name('Filter_t14_determine_document_x_request_unlicensed') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't14 determine document x request unlicensed'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t10_determine_necessity_to_stop_indication =" @Priority(50) @Name('Filter_t10_determine_necessity_to_stop_indication') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't10 determine necessity to stop indication'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t19_determine_report_y_to_stop_indication =" @Priority(50) @Name('Filter_t19_determine_report_y_to_stop_indication') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't19 determine report y to stop indication'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t20_print_report_y_to_stop_indication =" @Priority(50) @Name('Filter_t20_print_report_y_to_stop_indication') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't20 print report y to stop indication'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t18_adjust_report_y_to_stop_indicition =" @Priority(50) @Name('Filter_t18_adjust_report_y_to_stop_indicition') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't18 adjust report y to stop indicition'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t12_check_document_x_request_unlicensed =" @Priority(50) @Name('Filter_t12_check_document_x_request_unlicensed') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't12 check document x request unlicensed'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t17_check_report_y_to_stop_indication =" @Priority(50) @Name('Filter_t17_check_report_y_to_stop_indication') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't17 check report y to stop indication'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t03_adjust_confirmation_of_receipt =" @Priority(50) @Name('Filter_t03_adjust_confirmation_of_receipt') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't03 adjust confirmation of receipt'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t07_1_draft_intern_advice_aspect_1 =" @Priority(50) @Name('Filter_t07_1_draft_intern_advice_aspect_1') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't07-1 draft intern advice aspect 1'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t07_2_draft_intern_advice_aspect_2 =" @Priority(50) @Name('Filter_t07_2_draft_intern_advice_aspect_2') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't07-2 draft intern advice aspect 2'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t07_3_draft_intern_advice_hold_for_aspect_3 =" @Priority(50) @Name('Filter_t07_3_draft_intern_advice_hold_for_aspect_3') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't07-3 draft intern advice hold for aspect 3'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t07_4_draft_internal_advice_to_hold_for_type_4 =" @Priority(50) @Name('Filter_t07_4_draft_internal_advice_to_hold_for_type_4') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't07-4 draft internal advice to hold for type 4'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t07_5_draft_intern_advice_aspect_5 =" @Priority(50) @Name('Filter_t07_5_draft_intern_advice_aspect_5') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't07-5 draft intern advice aspect 5'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t08_draft_and_send_request_for_advice =" @Priority(50) @Name('Filter_t08_draft_and_send_request_for_advice') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't08 draft and send request for advice'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t09_1_process_or_receive_external_advice_from_party_1 =" @Priority(50) @Name('Filter_t09_1_process_or_receive_external_advice_from_party_1') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't09-1 process or receive external advice from party 1'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t09_2_process_or_receive_external_advice_from_party_2 =" @Priority(50) @Name('Filter_t09_2_process_or_receive_external_advice_from_party_2') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't09-2 process or receive external advice from party 2'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t09_3_process_or_receive_external_advice_from_party_3 =" @Priority(50) @Name('Filter_t09_3_process_or_receive_external_advice_from_party_3') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't09-3 process or receive external advice from party 3'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t09_4_process_or_receive_external_advice_from_party_4 =" @Priority(50) @Name('Filter_t09_4_process_or_receive_external_advice_from_party_4') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't09-4 process or receive external advice from party 4'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t11_create_document_x_request_unlicensed =" @Priority(50) @Name('Filter_t11_create_document_x_request_unlicensed') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't11 create document x request unlicensed'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t16_report_reasons_to_hold_request =" @Priority(50) @Name('Filter_t16_report_reasons_to_hold_request') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't16 report reasons to hold request'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t02_check_confirmation_of_receipt =" @Priority(50) @Name('Filter_t02_check_confirmation_of_receipt') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't02 check confirmation of receipt'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t04_determine_confirmation_of_receipt =" @Priority(50) @Name('Filter_t04_determine_confirmation_of_receipt') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't04 determine confirmation of receipt'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t05_print_and_send_confirmation_of_receipt =" @Priority(50) @Name('Filter_t05_print_and_send_confirmation_of_receipt') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from  LabeledEvent.win:time(1 sec) as T where activity = 't05 print and send confirmation of receipt'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

        String epl_Filter_t06_determine_necessity_of_stop_advice =" @Priority(50) @Name('Filter_t06_determine_necessity_of_stop_advice') insert into FilterLabeledEvent (caseID, activity , timestamp, probability, initTime) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability, "+initTime+"   from LabeledEvent.win:time(1 sec) as T where activity = 't06 determine necessity of stop advice'  and probability >= " + logProb + " group by caseID order by probability desc limit 1 ;";

//        String epl_Fail = "@Priority(0) @Name('Fail') insert into FailCorrelation (activity , timestamp , initTime) select ue.activity, ue.timestamp,  "+initTime+" from pattern [ ue=UnlabeledEvent and not fe=FilterLabeledEvent(activity=ue.activity and timestamp=ue.timestamp) where timer:within(60 sec)]#time(60 sec); ";
        String epl_Fail = " @Priority(0) @Name('Fail') insert into FailCorrelation (activity , timestamp , initTime) select ue.activity, ue.timestamp,  "+initTime+" from pattern [ ue=UnlabeledEvent -> (timer:interval(87 min) and not fe=FilterLabeledEvent(activity=ue.activity and timestamp=ue.timestamp)) ]";
...
*/
        ...
        new UnlabeledEventSource(filePath, 8577, eventService, "UnlabeledEvent").run();//take 35 records from UnlabeledEvent
