...
public class Runner_loop1000_NarrowH {
...
//    	String labeledEvents = "C:\\IH\\Docs\\eclipse-ws2019\\CEPForEventCorrelation_latency\\loop1000_NarrowH_labeled_latency.csv";
//    	String labeledEvents = "C:\\IH\\Docs\\eclipse-ws2019\\CEPForEventCorrelation_latency\\loop1000_eventID_NarrowH_labeled_H-_latency.csv"; //(45000), instead of 60,000
    	String labeledEvents = "C:\\IH\\Docs\\eclipse-ws2019\\CEPForEventCorrelation_latency\\loop1000_eventID_NarrowH_labeled_H--_latency.csv"; //(30000), instead of 60,000
        ...
        /*// H- queries
        String epl_TE_d =" @Priority(5) @Name('TE_d') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'd' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='a') or every pred=FilterLabeledEvent(activity='e') -> every succ=UnlabeledEvent(activity='d')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 45000 and (succ.timestamp - pred.timestamp) <=45000;";

        String epl_TE_b =" @Priority(5) @Name('TE_b') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'b' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'd') -> every succ=UnlabeledEvent(activity='b')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 45000 and (succ.timestamp - pred.timestamp) <=45000;";

        String epl_TE_c =" @Priority(5) @Name('TE_c') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'c' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='c')) where timer:within(91 sec)]#time(91 sec)  where (succ.timestamp - pred.timestamp) >= 105000 and (succ.timestamp - pred.timestamp) <=105000;";

        String epl_TE_e =" @Priority(5) @Name('TE_e') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'e' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='e')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 45000 and (succ.timestamp - pred.timestamp) <=45000;";

        String epl_TE_f =" @Priority(5) @Name('TE_f') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'f' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='f')) where timer:within(91 sec)]#time(91 sec)  where (succ.timestamp - pred.timestamp) >= 105000 and (succ.timestamp - pred.timestamp) <=105000;";

        String epl_TE_g =" @Priority(5) @Name('TE_g') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'g' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'c') -> every succ=UnlabeledEvent(activity='g')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 45000 and (succ.timestamp - pred.timestamp) <=45000;";

        String epl_TE_h =" @Priority(5) @Name('TE_h') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'h' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='g') or every pred=FilterLabeledEvent(activity='f') -> every succ=UnlabeledEvent(activity='h')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 45000 and (succ.timestamp - pred.timestamp) <=45000;";

        // */
        
        
        //*//H-- queries
        String epl_TE_d =" @Priority(5) @Name('TE_d') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'd' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='a') or every pred=FilterLabeledEvent(activity='e') -> every succ=UnlabeledEvent(activity='d')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 30000 and (succ.timestamp - pred.timestamp) <=30000;";

        String epl_TE_b =" @Priority(5) @Name('TE_b') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'b' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'd') -> every succ=UnlabeledEvent(activity='b')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 30000 and (succ.timestamp - pred.timestamp) <=30000;";

        String epl_TE_c =" @Priority(5) @Name('TE_c') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'c' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='c')) where timer:within(91 sec)]#time(91 sec)  where (succ.timestamp - pred.timestamp) >= 90000 and (succ.timestamp - pred.timestamp) <=90000;";

        String epl_TE_e =" @Priority(5) @Name('TE_e') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'e' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='e')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 30000 and (succ.timestamp - pred.timestamp) <=30000;";

        String epl_TE_f =" @Priority(5) @Name('TE_f') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'f' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='f')) where timer:within(91 sec)]#time(91 sec)  where (succ.timestamp - pred.timestamp) >= 90000 and (succ.timestamp - pred.timestamp) <=90000;";

        String epl_TE_g =" @Priority(5) @Name('TE_g') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'g' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'c') -> every succ=UnlabeledEvent(activity='g')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 30000 and (succ.timestamp - pred.timestamp) <=30000;";

        String epl_TE_h =" @Priority(5) @Name('TE_h') insert into TempEvent (eventID, caseID, activity, timestamp) select distinct succ.eventID, pred.caseID, 'h' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='g') or every pred=FilterLabeledEvent(activity='f') -> every succ=UnlabeledEvent(activity='h')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 30000 and (succ.timestamp - pred.timestamp) <=30000;";
		//*/
