...
public class UnlabeledEventSource_eventID implements Runnable {
    ...
    public UnlabeledEventSource_eventID(String filePath, EPEventService service, String type) {
        this.filePath = filePath;
        this.sender = service.getEventSender(type);
        this.service = service;
    }

    public UnlabeledEventSource_eventID(String filePath, int numRecordsToEmit, EPEventService service, String type) {
        this.filePath = filePath;
        this.sender = service.getEventSender(type);
        this.service = service;
        this.filePath = filePath;
    ...
    private void send(String[] data, int ts)  {
        ...
        sender.sendEvent(new UnlabeledEvent(Long.parseLong(data[2].trim()),-1, data[0].trim(), ts,-1));
//        try {
//			Thread.sleep(900);
//		} catch (InterruptedException e) {
//			// TODO Auto-generated catch block
...
//		}
    ...
    private void send(String[] data, long ts) {
        ...
        //Here you can control what to send on the stream
        sender.sendEvent(new UnlabeledEvent(Long.parseLong(data[2].trim()),-1, data[1].trim(), ts,-1));
