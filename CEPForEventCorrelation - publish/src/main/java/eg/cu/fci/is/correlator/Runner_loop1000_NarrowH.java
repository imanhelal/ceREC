...
public class Runner_loop1000_NarrowH {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
    	...
    	String labeledEvents = "C:\\IH\\eclipse-workspace\\CEPForEventCorrelation\\loop1000_NarrowH_labeled.csv";
        ...
        String epl_TE_d =" @Priority(5) @Name('TE_d') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'd' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='a' or activity='e') -> every succ=UnlabeledEvent(activity='d')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 30000 and (succ.timestamp - pred.timestamp) <=30000;";

        String epl_TE_b =" @Priority(5) @Name('TE_b') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'b' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'd') -> every succ=UnlabeledEvent(activity='b')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 30000 and (succ.timestamp - pred.timestamp) <=30000;";

        String epl_TE_c =" @Priority(5) @Name('TE_c') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'c' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='c')) where timer:within(91 sec)]#time(91 sec)  where (succ.timestamp - pred.timestamp) >= 90000 and (succ.timestamp - pred.timestamp) <=90000;";

        String epl_TE_e =" @Priority(5) @Name('TE_e') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'e' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='e')) where timer:within(31 sec)]#time(31 sec)  where (succ.timestamp - pred.timestamp) >= 30000 and (succ.timestamp - pred.timestamp) <=30000;";

        String epl_TE_f =" @Priority(5) @Name('TE_f') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'f' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='f')) where timer:within(91 sec)]#time(91 sec)  where (succ.timestamp - pred.timestamp) >= 90000 and (succ.timestamp - pred.timestamp) <=90000;";
