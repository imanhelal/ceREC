...
public class Runner_CoSeLoG_XOR_only {

    public static void main(String[] args) throws InterruptedException, IOException {


    	String labeledEvents = "C:\\IH\\Docs\\eclipse-ws2019\\CEPForEventCorrelation\\CoSeLoG_labeled.csv";
        ...
        String epl_start_case_confirmation_of_receipt =" @Name('start_case_confirmation_of_receipt')  insert into FilterLabeledEvent (caseID, activity, timestamp, probability)  select (select coalesce(max(caseID)+1,1) from Cases) as caseID, UE.activity, UE.timestamp, 1.0  from UnlabeledEvent as UE where UE.activity = 'confirmation of receipt'; ";

        String epl_TE_t15_print_document_x_request_unlicensed =" @Priority(5) @Name('TE_t15_print_document_x_request_unlicensed') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't15 print document x request unlicensed' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 't10 determine necessity to stop indication')) -> every succ=UnlabeledEvent(activity='t15 print document x request unlicensed') ]#time(85 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=84780000;";

        String epl_TE_t14_determine_document_x_request_unlicensed =" @Priority(5) @Name('TE_t14_determine_document_x_request_unlicensed') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't14 determine document x request unlicensed' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t04 determine confirmation of receipt' or activity='t02 check confirmation of receipt') -> every succ=UnlabeledEvent(activity='t14 determine document x request unlicensed') ]#time(86 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=85920000;";

        String epl_TE_t10_determine_necessity_to_stop_indication =" @Priority(5) @Name('TE_t10_determine_necessity_to_stop_indication') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't10 determine necessity to stop indication' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 't06 determine necessity of stop advice')) -> every succ=UnlabeledEvent(activity='t10 determine necessity to stop indication') ]#time(87 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=86160000;";

        String epl_TE_t19_determine_report_y_to_stop_indication =" @Priority(5) @Name('TE_t19_determine_report_y_to_stop_indication') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't19 determine report y to stop indication' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 't17 check report y to stop indication')) -> every succ=UnlabeledEvent(activity='t19 determine report y to stop indication') ]#time(1 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=180000;";

        String epl_TE_t20_print_report_y_to_stop_indication =" @Priority(5) @Name('TE_t20_print_report_y_to_stop_indication') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't20 print report y to stop indication' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 't19 determine report y to stop indication')) -> every succ=UnlabeledEvent(activity='t20 print report y to stop indication') ]#time(1 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=120000;";

        String epl_TE_t18_adjust_report_y_to_stop_indicition =" @Priority(5) @Name('TE_t18_adjust_report_y_to_stop_indicition') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't18 adjust report y to stop indicition' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 't17 check report y to stop indication')) -> every succ=UnlabeledEvent(activity='t18 adjust report y to stop indicition') ]#time(1 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=60000;";

        String epl_TE_t12_check_document_x_request_unlicensed =" @Priority(5) @Name('TE_t12_check_document_x_request_unlicensed') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't12 check document x request unlicensed' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 't11 create document x request unlicensed')) -> every succ=UnlabeledEvent(activity='t12 check document x request unlicensed') ]#time(82 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=81540000;";

        String epl_TE_t17_check_report_y_to_stop_indication =" @Priority(5) @Name('TE_t17_check_report_y_to_stop_indication') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't17 check report y to stop indication' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t16 report reasons to hold request' or activity='t18 adjust report y to stop indicition') -> every succ=UnlabeledEvent(activity='t17 check report y to stop indication') ]#time(1 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=780000;";

        String epl_TE_t03_adjust_confirmation_of_receipt =" @Priority(5) @Name('TE_t03_adjust_confirmation_of_receipt') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't03 adjust confirmation of receipt' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t03 adjust confirmation of receipt') ]#time(86 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=85920000;";

        String epl_TE_t07_1_draft_intern_advice_aspect_1 =" @Priority(5) @Name('TE_t07_1_draft_intern_advice_aspect_1') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't07-1 draft intern advice aspect 1' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t07-1 draft intern advice aspect 1') ]#time(86 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=85680000;";

        String epl_TE_t07_2_draft_intern_advice_aspect_2 =" @Priority(5) @Name('TE_t07_2_draft_intern_advice_aspect_2') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't07-2 draft intern advice aspect 2' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t07-2 draft intern advice aspect 2') ]#time(86 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=85860000;";

        String epl_TE_t07_3_draft_intern_advice_hold_for_aspect_3 =" @Priority(5) @Name('TE_t07_3_draft_intern_advice_hold_for_aspect_3') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't07-3 draft intern advice hold for aspect 3' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t07-3 draft intern advice hold for aspect 3') ]#time(3 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=2460000;";

        String epl_TE_t07_4_draft_internal_advice_to_hold_for_type_4 =" @Priority(5) @Name('TE_t07_4_draft_internal_advice_to_hold_for_type_4') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't07-4 draft internal advice to hold for type 4' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t07-4 draft internal advice to hold for type 4') ]#time(81 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=80400000;";

        String epl_TE_t07_5_draft_intern_advice_aspect_5 =" @Priority(5) @Name('TE_t07_5_draft_intern_advice_aspect_5') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't07-5 draft intern advice aspect 5' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t07-5 draft intern advice aspect 5') ]#time(83 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=82740000;";

        String epl_TE_t08_draft_and_send_request_for_advice =" @Priority(5) @Name('TE_t08_draft_and_send_request_for_advice') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't08 draft and send request for advice' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t08 draft and send request for advice') ]#time(73 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=72000000;";

        String epl_TE_t09_1_process_or_receive_external_advice_from_party_1 =" @Priority(5) @Name('TE_t09_1_process_or_receive_external_advice_from_party_1') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't09-1 process or receive external advice from party 1' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t09-1 process or receive external advice from party 1') ]#time(1 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=480000;";

        String epl_TE_t09_2_process_or_receive_external_advice_from_party_2 =" @Priority(5) @Name('TE_t09_2_process_or_receive_external_advice_from_party_2') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't09-2 process or receive external advice from party 2' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t09-2 process or receive external advice from party 2') ]#time(1 min)  where succ.timestamp - pred.timestamp >= 600 and succ.timestamp - pred.timestamp <=600000;";

        String epl_TE_t09_3_process_or_receive_external_advice_from_party_3 =" @Priority(5) @Name('TE_t09_3_process_or_receive_external_advice_from_party_3') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't09-3 process or receive external advice from party 3' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t09-3 process or receive external advice from party 3') ]#time(4 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=3540000;";

        String epl_TE_t09_4_process_or_receive_external_advice_from_party_4 =" @Priority(5) @Name('TE_t09_4_process_or_receive_external_advice_from_party_4') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't09-4 process or receive external advice from party 4' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t09-4 process or receive external advice from party 4') ]#time(3 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=2220000;";

        String epl_TE_t11_create_document_x_request_unlicensed =" @Priority(5) @Name('TE_t11_create_document_x_request_unlicensed') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't11 create document x request unlicensed' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t11 create document x request unlicensed') ]#time(84 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=83100000;";

        String epl_TE_t16_report_reasons_to_hold_request =" @Priority(5) @Name('TE_t16_report_reasons_to_hold_request') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't16 report reasons to hold request' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t03 adjust confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='confirmation of receipt') -> every succ=UnlabeledEvent(activity='t16 report reasons to hold request') ]#time(83 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=82140000;";

        String epl_TE_t02_check_confirmation_of_receipt =" @Priority(5) @Name('TE_t02_check_confirmation_of_receipt') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't02 check confirmation of receipt' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t12 check document x request unlicensed' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='t03 adjust confirmation of receipt' or activity='confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t20 print report y to stop indication') -> every succ=UnlabeledEvent(activity='t02 check confirmation of receipt') ]#time(87 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=86340000;";

        String epl_TE_t04_determine_confirmation_of_receipt =" @Priority(5) @Name('TE_t04_determine_confirmation_of_receipt') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't04 determine confirmation of receipt' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t12 check document x request unlicensed' or activity='t08 draft and send request for advice' or activity='t09-1 process or receive external advice from party 1' or activity='t09-2 process or receive external advice from party 2' or activity='t09-3 process or receive external advice from party 3' or activity='t09-4 process or receive external advice from party 4' or activity='t03 adjust confirmation of receipt' or activity='confirmation of receipt' or activity='t07-1 draft intern advice aspect 1' or activity='t07-2 draft intern advice aspect 2' or activity='t07-3 draft intern advice hold for aspect 3' or activity='t07-4 draft internal advice to hold for type 4' or activity='t07-5 draft intern advice aspect 5' or activity='t20 print report y to stop indication') -> every succ=UnlabeledEvent(activity='t04 determine confirmation of receipt') ]#time(87 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=86220000;";

        String epl_TE_t05_print_and_send_confirmation_of_receipt =" @Priority(5) @Name('TE_t05_print_and_send_confirmation_of_receipt') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't05 print and send confirmation of receipt' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t04 determine confirmation of receipt' or activity='t02 check confirmation of receipt' or activity='t14 determine document x request unlicensed') -> every succ=UnlabeledEvent(activity='t05 print and send confirmation of receipt') ]#time(87 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=86340000;";

        String epl_TE_t06_determine_necessity_of_stop_advice =" @Priority(5) @Name('TE_t06_determine_necessity_of_stop_advice') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 't06 determine necessity of stop advice' as activity, succ.timestamp as timestamp from pattern [every pred=FilterLabeledEvent(activity='t04 determine confirmation of receipt' or activity='t02 check confirmation of receipt' or activity='t14 determine document x request unlicensed' or activity='t05 print and send confirmation of receipt') -> every succ=UnlabeledEvent(activity='t06 determine necessity of stop advice') ]#time(87 min)  where succ.timestamp - pred.timestamp >= 0 and succ.timestamp - pred.timestamp <=86340000;";
        ...
        String epl_Filter_t15_print_document_x_request_unlicensed =" @Priority(50) @Name('Filter_t15_print_document_x_request_unlicensed') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't15 print document x request unlicensed'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
        ...
        String epl_Filter_t10_determine_necessity_to_stop_indication =" @Priority(50) @Name('Filter_t10_determine_necessity_to_stop_indication') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't10 determine necessity to stop indication'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
        ...
        String epl_Filter_t20_print_report_y_to_stop_indication =" @Priority(50) @Name('Filter_t20_print_report_y_to_stop_indication') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't20 print report y to stop indication'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
        ...
        String epl_Filter_t03_adjust_confirmation_of_receipt =" @Priority(50) @Name('Filter_t03_adjust_confirmation_of_receipt') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't03 adjust confirmation of receipt'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
        ...
        String epl_Filter_t07_5_draft_intern_advice_aspect_5 =" @Priority(50) @Name('Filter_t07_5_draft_intern_advice_aspect_5') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't07-5 draft intern advice aspect 5'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";

        String epl_Filter_t08_draft_and_send_request_for_advice =" @Priority(50) @Name('Filter_t08_draft_and_send_request_for_advice') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't08 draft and send request for advice'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";

        String epl_Filter_t09_1_process_or_receive_external_advice_from_party_1 =" @Priority(50) @Name('Filter_t09_1_process_or_receive_external_advice_from_party_1') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't09-1 process or receive external advice from party 1'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
        ...
        String epl_Filter_t09_3_process_or_receive_external_advice_from_party_3 =" @Priority(50) @Name('Filter_t09_3_process_or_receive_external_advice_from_party_3') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't09-3 process or receive external advice from party 3'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
        ...
        String epl_Filter_t16_report_reasons_to_hold_request =" @Priority(50) @Name('Filter_t16_report_reasons_to_hold_request') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't16 report reasons to hold request'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
        ...
        String epl_Filter_t04_determine_confirmation_of_receipt =" @Priority(50) @Name('Filter_t04_determine_confirmation_of_receipt') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't04 determine confirmation of receipt'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
        ...
        String epl_Filter_t06_determine_necessity_of_stop_advice =" @Priority(50) @Name('Filter_t06_determine_necessity_of_stop_advice') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 't06 determine necessity of stop advice'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
...
*/
        ...
        String filePath = "C:\\IH\\Docs\\eclipse-ws2019\\CEPForEventCorrelation\\CoSeLoG_unLabeled.csv";
