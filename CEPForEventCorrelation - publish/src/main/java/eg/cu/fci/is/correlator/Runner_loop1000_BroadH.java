...
public class Runner_loop1000_BroadH {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
    	...
    	String labeledEvents = "C:\\IH\\eclipse-workspace\\CEPForEventCorrelation\\loop1000_BroadH_labeled_5_1.csv";
        ...
        String epl_TE_d =" @Priority(5) @Name('TE_d') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'd' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='a' or activity='e') -> every succ=UnlabeledEvent(activity='d')) where timer:within(121 sec)]#time(121 sec)  where (succ.timestamp - pred.timestamp) >= 120000 and (succ.timestamp - pred.timestamp) <=120000;";

        String epl_TE_b =" @Priority(5) @Name('TE_b') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'b' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'd') -> every succ=UnlabeledEvent(activity='b')) where timer:within(121 sec)]#time(121 sec)  where (succ.timestamp - pred.timestamp) >= 120000 and (succ.timestamp - pred.timestamp) <=120000;";

        String epl_TE_c =" @Priority(5) @Name('TE_c') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'c' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='c')) where timer:within(181 sec)]#time(181 sec)  where (succ.timestamp - pred.timestamp) >= 180000 and (succ.timestamp - pred.timestamp) <=180000;";

        String epl_TE_e =" @Priority(5) @Name('TE_e') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'e' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='e')) where timer:within(121 sec)]#time(121 sec)  where (succ.timestamp - pred.timestamp) >= 120000 and (succ.timestamp - pred.timestamp) <=120000;";

        String epl_TE_f =" @Priority(5) @Name('TE_f') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'f' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'b') -> every succ=UnlabeledEvent(activity='f')) where timer:within(181 sec)]#time(181 sec)  where (succ.timestamp - pred.timestamp) >= 180000 and (succ.timestamp - pred.timestamp) <=180000;";

        String epl_TE_g =" @Priority(5) @Name('TE_g') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'g' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity = 'c') -> every succ=UnlabeledEvent(activity='g')) where timer:within(121 sec)]#time(121 sec)  where (succ.timestamp - pred.timestamp) >= 120000 and (succ.timestamp - pred.timestamp) <=120000;";

        String epl_TE_h =" @Priority(5) @Name('TE_h') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'h' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='g' or activity='f') -> every succ=UnlabeledEvent(activity='h')) where timer:within(121 sec)]#time(121 sec)  where (succ.timestamp - pred.timestamp) >= 120000 and (succ.timestamp - pred.timestamp) <=120000;";

        String epl_Correlate_d =" @Priority(20) @Name('Correlate_d') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , min(((select count(caseID)  from TempEvent.win:time_batch(1 sec) where caseID = T.caseID and activity = T.activity and timestamp=T.timestamp) /count(all caseID, group_by:timestamp)),1.0) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'd'  group by caseID order by timestamp desc  ; ";
