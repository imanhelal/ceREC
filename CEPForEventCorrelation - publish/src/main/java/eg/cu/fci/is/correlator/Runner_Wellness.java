...
public class Runner_Wellness {

    public static void main(String[] args) throws InterruptedException, IOException {


    	String labeledEvents = "C:\\IH\\eclipse-workspace\\CEPForEventCorrelation\\Wellness_labeled.csv";
        ...
        String epl_TE_e =" @Priority(5) @Name('TE_e') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'e' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='g') -> every succ=UnlabeledEvent(activity='e'))  or ((every pred=FilterLabeledEvent(activity='b') and every inter1 = FilterLabeledEvent(activity='c') and every inter2 = FilterLabeledEvent(activity='d')) -> every succ=UnlabeledEvent(activity='e')) where timer:within(11 min) ]#time(11 min)  where ( pred.caseID = inter2.caseID and pred.caseID = inter1.caseID and (succ.timestamp - max(pred.timestamp,inter1.timestamp,inter2.timestamp)) >= 120000 and (succ.timestamp - max(pred.timestamp,inter1.timestamp,inter2.timestamp)) <=600000 ) or ( (succ.timestamp - pred.timestamp) >= 120000 and (succ.timestamp - pred.timestamp) <=600000 )  ;";
//        " @Priority(5) @Name('TE_e') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'e' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='g') -> every succ=UnlabeledEvent(activity='e'))  or ((every pred=FilterLabeledEvent(activity='b') and every inter1 = FilterLabeledEvent(activity='c') and every inter2 = FilterLabeledEvent(activity='d')) -> every succ=UnlabeledEvent(activity='e')) where timer:within(11 min) ]#time(11 min)  where ( pred.caseID = inter2.caseID and pred.caseID = inter1.caseID and (succ.timestamp - max(pred.timestamp,inter1.timestamp,inter2.timestamp)) >= 120000 and (succ.timestamp - max(pred.timestamp,inter1.timestamp,inter2.timestamp)) <=600000 ) or ( (succ.timestamp - pred.timestamp) >= 120000 and (succ.timestamp - pred.timestamp) <=600000 )  ;";
//        " @Priority(5) @Name('TE_e') insert into TempEvent (caseID, activity, timestamp) select distinct pred.caseID, 'e' as activity, succ.timestamp as timestamp from pattern [(every pred=FilterLabeledEvent(activity='g') -> every succ=UnlabeledEvent(activity='e'))  or ((every pred=FilterLabeledEvent(activity='b') and every inter1 = FilterLabeledEvent(activity='c') and every inter2 = FilterLabeledEvent(activity='d')) -> every succ=UnlabeledEvent(activity='e')) where timer:within(11 min) ]#time(11 min)  where ( pred.caseID = inter2.caseID and (succ.timestamp - max(pred.timestamp,inter1.timestamp,inter2.timestamp)) >= 120000 and (succ.timestamp - max(pred.timestamp,inter1.timestamp,inter2.timestamp)) <=600000 ) or ( (succ.timestamp - pred.timestamp) >= 120000 and (succ.timestamp - pred.timestamp) <=600000 )  ;";
        ...
        String epl_Correlate_b =" @Priority(30) @Name('Correlate_b') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , min(((select count(caseID)  from TempEvent.win:time_batch(1 sec) where caseID = T.caseID and activity = T.activity and timestamp=T.timestamp) /count(all caseID, group_by:timestamp)),1.0) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'b'  group by caseID order by timestamp desc ; "; //limit 5 

        String epl_Correlate_c =" @Priority(40) @Name('Correlate_c') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , min(((select count(caseID)  from TempEvent.win:time_batch(1 sec) where caseID = T.caseID and activity = T.activity and timestamp=T.timestamp) /count(all caseID, group_by:timestamp)),1.0) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'c'  group by caseID order by timestamp desc ; "; //limit 5 

        String epl_Correlate_d =" @Priority(30) @Name('Correlate_d') insert into LabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , min(((select count(caseID)  from TempEvent.win:time_batch(1 sec) where caseID = T.caseID and activity = T.activity and timestamp=T.timestamp) /count(all caseID, group_by:timestamp)),1.0) as probability from TempEvent.win:time_batch(1 sec) as T  where activity = 'd'  group by caseID order by timestamp desc ; "; //limit 5 
        ...
        String epl_Filter_b =" @Priority(100) @Name('Filter_b') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 'b'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";

        String epl_Filter_c =" @Priority(100) @Name('Filter_c') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 'c'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";

        String epl_Filter_d =" @Priority(100) @Name('Filter_d') insert into FilterLabeledEvent (caseID, activity , timestamp, probability) select distinct caseID as caseID, last(activity) as activity, max(timestamp) as timestamp , probability from LabeledEvent.win:time(1 sec) as T where activity = 'd'  and probability >= 0.0 group by caseID order by probability desc limit 5 ;";
...
*/
        ...
        new UnlabeledEventSource(filePath, 43, eventService, "UnlabeledEvent").run();//take 35 records from UnlabeledEvent
